...
def launch_stretchy():
    ...
    dbg(f"Applying stretch: {cfg['x']}x{cfg['y']}")
    ...
    dbg("Launching Riot Client via ShellExecuteW...")
    ctypes.windll.shell32.ShellExecuteW(
        None, "open", riot_path,
...
def _set_resolution_via_api(width, height, hz=60):
    """Fallback: set resolution and refresh rate via ctypes if SetScreenResolution.exe is missing."""
